[
	...
	},
	{
		...
		src_json: {name: '@ryanatkn/fuz_template', version: '0.0.1'},
		name: '@ryanatkn/fuz_template',
	...
	},
	{
		...
		package_json: {
			...
			exports: {
				...
				'./deployments.js': {types: './dist/deployments.d.ts', default: './dist/deployments.js'},
				...
				'./gitops.task.js': {types: './dist/gitops.task.d.ts', default: './dist/gitops.task.js'},
		...
		src_json: {
			...
			modules: {
				...
				'./Modules_Nav.svelte': {path: 'Modules_Nav.svelte', declarations: []},
		...
		pull_requests: [
			{
				number: 28,
				title: 'change `repos.ts` from `deployments.json`',
				user: {login: 'ryanatkn'},
				draft: false,
			},
			{number: 27, title: 'upgrade eslint', user: {login: 'ryanatkn'}, draft: false},
		],
	},
	{
	...
	},
	{
		...
		src_json: {
			...
			modules: {
				...
				'./clean_fs.js': {
					path: 'clean_fs.ts',
					declarations: [{name: 'clean_fs', kind: 'function'}],
				},
				'./clean.task.js': {
					path: 'clean.task.ts',
					declarations: [
				...
				'./throttle.js': {
					path: 'throttle.ts',
					declarations: [{name: 'throttle', kind: 'function'}],
				},
				'./typecheck.task.js': {
		...
		check_runs: {status: 'completed', conclusion: 'success'},
		pull_requests: [
			{number: 482, title: 'upgrade eslint', user: {login: 'ryanatkn'}, draft: false},
		],
	},
];
